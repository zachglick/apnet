...
def train_multipole_model(molecules_t, multipoles_t, molecules_v, multipoles_v, modelpath):
    ...
    Rt, Zt, q_init_t, MTPt = util.padded_monomerdata(molecule_list_t, multipoles_t, pad_dim)
    Rv, Zv, q_init_v, MTPv = util.padded_monomerdata(molecule_list_v, multipoles_v, pad_dim)
    ...
    model = models.make_atom_model(mus, etas, pad_dim, nelem, nembed, nnodes, nmessage)
